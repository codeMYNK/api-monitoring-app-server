...
import consumer from "./services/processor/consumer.js"; // Adjust path if needed
...
app.use(
  cors({
    origin: [
      'https://api-monitoring-app-frontend.vercel.app', // Your exact Vercel URL
...
async function startServer() {
  try {
    ...
    // Inside startServer() after app.listen success:
    logger.info("Starting background event consumer...");
