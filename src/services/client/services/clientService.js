...
export class ClientService {
 ...
 /**
     ...
     * @param {Object} user - The user requesting the clients list
     * @returns {Array} - The list of clients
     */
    async getAllClients(user) {
        try {
            if (user.role !== APPLICATION_ROLES.SUPER_ADMIN) {
                throw new AppError("Access denied - Only Super Admin can view all clients", 403);
            }

            // Calls the existing find method in MongoClientRepository
